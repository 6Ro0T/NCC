...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#menu-admin">Cadets</a></li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                     <ul class="metismenu">
                        ...
                        <li class="active"><a href="quiz.php"><i class="fa fa-quora"></i><span>View Quiz</span></a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
								  ...
								  include('conn.php');
								  $counter=0;
								  $sql="select * from quiz where role='airforce'";
								  ...
								  <tr>
									...
									<td>
									<a href="<?php echo $row['quiz_link']?>" target="_blank"><?php echo $row['quiz_name']; ?></a>
									</td>
								  </tr>
								  <?php } ?>
								  </tbody>
